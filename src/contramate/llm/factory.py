"""Factory for creating LLM clients with LiteLLM as default"""
...
ClientType = Literal["litellm", "openai", "azure_openai"]


class LLMClientFactory:
    """Factory for creating LLM clients with sensible defaults

    Default client is LiteLLM with API token-based access.
    Automatically initializes settings from AppSettings.
    """

    def __init__(
        self,
        default_client_type: ClientType = "litellm",
        ...
        Args:
            default_client_type: Default client type to use ("litellm", "openai", "azure_openai")
    ...
    @classmethod
    def create_from_default(cls, client_type: ClientType = "litellm") -> "LLMClientFactory":
        """
...
def create_default_chat_client(client_type: ClientType = "litellm") -> BaseChatClient:
    """
...
def create_default_embedding_client(client_type: ClientType = "litellm") -> BaseEmbeddingClient:
    """
...
if __name__ == "__main__":
    ...
    async def test_factory():
        ...
        factory = LLMClientFactory.create_from_default("litellm")
